...
<table border="0" bgcolor="#e8e8e8" width="100%" style="margin:0.2em 0;" > <tr >
<td style="padding:0.5em;" ><pre># rpm -ivh pacemaker-repo-1.1.14-1.1.el7.x86_64.rpm
...
<td ><pre><tt><font color="#FF6600">--- pacemaker.combined.conf.1.1.14.org  2015-07-10 17:11:22.000000000 +0900</font>
