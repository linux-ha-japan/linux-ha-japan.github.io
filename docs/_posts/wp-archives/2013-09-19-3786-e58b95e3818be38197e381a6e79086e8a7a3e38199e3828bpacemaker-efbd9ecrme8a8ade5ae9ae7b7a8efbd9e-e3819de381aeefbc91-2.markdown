...
<pre><code># rm -f /var/lib/heartbeat/crm/*</code></pre>
...
<pre><code># rm -f /var/lib/pacemaker/cib/*</code></pre>
...
<pre><code># /etc/init.d/heartbeat start</code></pre>
...
<pre><code># initctl start pacemaker.combined</code></pre>
...
<pre><code># crm configure load update example01.crm</code></pre>
...
**Pacemaker-1.0系の場合**
<pre><code># /etc/init.d/heartbeat stop</code></pre>


**Pacemaker-1.1系,RHEL6の場合**
<pre><code># initctl stop pacemaker.combined</code></pre>
...
<pre><span style="font-size: medium;"><strong>コラム Dummyって？</strong></span>
...
<pre><code>[root@pm01 ~]# ls /var/run/resource-agents/
