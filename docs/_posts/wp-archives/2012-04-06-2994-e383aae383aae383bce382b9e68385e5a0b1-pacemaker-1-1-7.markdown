...
<blockquote>
バグフィックスも含めた全てのチェンジログは[GitHub](https://raw.github.com/ClusterLabs/pacemaker/master/ChangeLog)で参照することができます。
</blockquote>
...
および、ClusterLabからダウンロード可能な1.0.12を指します。
  ...
  * Pacemaker 1.0.11 [Linux-HA Japan](/wp/dl/packages)
...
また、Heartbeat 3.0.5とPacemaker 1.1.7を組み合わせて動作させる場合は、ha.cfに下記の設定を追加してください。
    ...
    traditional_compression yes</code>
...
<blockquote>
ソースコードのtarボールは[GitHub](https://nodeload.github.com/ClusterLabs/pacemaker/tarball/Pacemaker-1.1.7)からダウンロードすることができます。
</blockquote>
...
<blockquote>
インストール手順などはClusterLabsの[Wikiページ](http://clusterlabs.org/wiki/Install)を参照してください。
</blockquote>
