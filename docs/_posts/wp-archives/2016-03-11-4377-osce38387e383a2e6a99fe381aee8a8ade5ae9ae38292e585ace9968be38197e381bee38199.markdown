...
<pre><code>Last updated: Wed Mar  2 13:04:40 2016
...
<pre><code>primitive prmStonith1-1 stonith:external/stonith-helper \
	params \
...
<pre><code>location rsc_location-grpStonith1-3 grpStonith1 \
...
以下、その設定箇所の抜粋です。
<pre><code>primitive vip-master ocf:heartbeat:IPaddr2 \
～中略～
...
144～153行目：
<pre><code>primitive prmDiskd1 ocf:pacemaker:diskd \
	params \
...
144～153行目：
<pre><code>primitive prmPing ocf:pacemaker:ping \
	params \
...
<pre><code>location rsc_location-msPostgresql-1 msPostgresql \
...
<pre><code>colocation rsc_colocation-msPostgresql-clnPing-1      INFINITY: msPostgresql  clnPing
...
<pre><code>order rsc_order-clnPing-msPostgresql-1      0:        clnPing              msPostgresql       symmetrical=false
...
96～120行目：
<pre><code>primitive pgsql ocf:heartbeat:pgsql \
	params \
