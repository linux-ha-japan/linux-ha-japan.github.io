...
<td style="background-color: #ffffcc;" ># drbdadm down all
# service drbd stop
</td>
</tr>
</tbody>
...
<td style="background-color: #ffffcc;" ># service heartbeat stop
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># rpm -e drbd-pacemaker drbd-utils drbd-km-2.6.18_238.el5-8.3.11.1-1
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># rpm -ihv drbd-utils-8.4.0-1.x86_64.rpm
# rpm –ihv drbd-km-2.6.18_238.el5-8.4.0-1.x86_64.rpm
# rpm –ihv drbd-pacemaker-8.4.0-1.x86_64.rpm
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># chkconfig drbd off
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># cp -p /etc/drbd.conf.rpmsave /etc/drbd.conf
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm wipe-md all
...
<td style="background-color: #ffffcc;" ># service drbd start
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># service heartbeat start
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># cat /proc/drbd
</td>
</tr>
</tbody>
</table>
...
<td >version: 8.4.0
(api:1/proto:86-100)
GIT-hash: 28753f559ab51b549d16bcf487fe625d5919c49c build by root@srv01,2011-07-25 13:46:08
0: cs:SyncTarget ro:Secondary/Primary ds:Inconsistent/UpToDate C r-----
ns:0 nr:0 dw:0 dr:263296 al:0 bm:15 lo:22 pe:46 ua:0 ap:0 ep:1 wo:b oos:9513840
...
<td style="background-color: #ffffcc;" ># umount <dir>
...
<td style="background-color: #ffffcc;" ># drbdadm primary all
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm dump all
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm dump all > /tmp/drbd.conf
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># vi /tmp/drbd.conf
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: white;" >global {
usage-count no;
}  
...
<td style="background-color: #ffffcc;" ># cp -p /etc/drbd.conf /etc/drbd.conf.org
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># mv /tmp/drbd.conf /etc/drbd.conf
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># scp -p /etc/drbd.conf <対向ノード>:/etc/drbd.conf
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm adjust all
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm secondary <resource>
...
<td style="background-color: #ffffcc;" ># drbdadm -- --overwrite-data-of-peer primary <resource>
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm primary --force <resource>
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm net-options --protocol=A <resource>
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm adjust <resource>
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #ffffcc;" ># drbdadm net-options --protocol=C --allow-two-primaries <resource>
</td>
</tr>
</tbody>
</table>
