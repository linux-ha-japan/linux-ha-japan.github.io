...
>     * [Linbitのサポートページ(ライセンスを購入したユーザのみ利用可能です)](http://www.linbit.com/support/drbd-8.3.14/)
	
> 
	
>     * [ソースコード](http://oss.linbit.com/drbd/8.3/drbd-8.3.14.tar.gz)
	
> 
	
>     * [リポジトリ](http://git.drbd.org/gitweb.cgi?p=drbd-8.3.git;a=tag;h=refs/tags/drbd-8.3.14)
