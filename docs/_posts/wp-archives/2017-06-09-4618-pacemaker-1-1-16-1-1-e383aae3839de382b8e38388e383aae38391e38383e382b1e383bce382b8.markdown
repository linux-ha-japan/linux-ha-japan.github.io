...
<table border="0" bgcolor="#e8e8e8" width="100%" style="margin:0.2em 0;" > <tr >
<td style="padding:0.5em;" ><pre># yum install -y pacemaker-repo-1.1.16-1.1.el7.x86_64.rpm
...
<td ><pre><tt><font color="#FF6600">--- pacemaker.combined.conf.1.1.15.org  2016-09-09 11:10:23.000000000 +0900</font>
