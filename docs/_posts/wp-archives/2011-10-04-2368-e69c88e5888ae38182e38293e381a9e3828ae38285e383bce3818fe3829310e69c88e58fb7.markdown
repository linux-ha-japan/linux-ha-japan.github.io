...
<pre><span style="font-family: verdana,geneva;">[root@node01 ~]# <span style="color: #008000;"><strong>which hb_report</strong></span></span>
<span style="font-family: verdana,geneva;">/usr/sbin/hb_report</span></pre>


<pre><span style="font-family: verdana,geneva;">[root@node01 ~]# <strong><span style="color: #008000;">hb_report</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 ~]# <strong><span style="color: #008000;">hb_report -f 13:20:00 -t 13:40:00 -u root -D -C /tmp/hb_report</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 ~]# <strong><span style="color: #008000;">tar tjfv /tmp/hb_report.tar.bz2</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 ~]# <strong><span style="color: #008000;">cd /tmp/</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 hb_report]# <strong><span style="color: #008000;">cat description.txt</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 hb_report]# <strong><span style="color: #008000;">cat crm_mon.txt</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 hb_report]# <strong><span style="color: #008000;">ls -l node01</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 hb_report]# <strong><span style="color: #008000;">ls -l node02/pengine/</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 ~]# <strong><span style="color: #008000;">tar tjfv /tmp/hb_report.tar.bz2 | grep ha-log</span></strong></span>
...
<pre><span style="font-family: verdana,geneva;">[root@node01 ~]#<strong><span style="color: #008000;"> crm_report -f "2011-10-4 13:20:00" -t "2011-10-4 13:40:00" \
