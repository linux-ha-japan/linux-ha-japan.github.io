...
<td style="padding:0.5em;" ><pre># rpm -ivh pacemaker-repo-1.1.12-1.1.el6.x86_64.rpm
...
<table border="0" bgcolor="#e8e8e8" width="100%" style="margin:0.2em 0;" > <tr >
<td style="padding:0.5em;" ><pre># cp -p /usr/lib/systemd/system/corosync.service /etc/systemd/system
...
<table border="0" bgcolor="#e8e8e8" width="100%" style="margin:0.2em 0;" > <tr >
<td style="padding:0.5em;" ><pre># cp -p /usr/lib/systemd/system/pacemaker.service /etc/systemd/system
