...
<blockquote>
- [manページ](https://github.com/corosync/corosync/tree/master/man)が大幅に更新されています。
- テストツールが統合されました。
...
詳細は[manページ(votequorum.5)](https://github.com/corosync/corosync/blob/master/man/votequorum.5)を参照してください。
</blockquote>
...
Corosync 2.0.0は Corosync の[サイト](http://www.corosync.org)からダウンロードすることができます。
