...
[![Pacemaer 基本構成](/assets/images/wp-content/pm_simple_env.jpg)](/wp/dl/pminstall_cent5/pm_simple_env)


さらに、Pacemakerでは、下図のように、クラスタ制御部にHeartbeat 3 またはCorosync を使用することができますので、それぞれの場合について記述します。


[![hb3_or_corosync](/assets/images/wp-content/hb3_or_corosync.jpg)](/wp/dl/pminstall_cent5/hb3_or_corosync)
...
この状態では、リソース(制御対象のアプリケーション)を定義していないため、続いて[crmコマンドを使用してリソース制御部の設定](/wp/dl/pm-crm-setting)を行っていきます。
